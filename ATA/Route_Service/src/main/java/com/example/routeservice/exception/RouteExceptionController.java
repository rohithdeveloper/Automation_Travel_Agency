...
@ControllerAdvice
public class RouteExceptionController extends ResponseEntityExceptionHandler{
//
...
//	}
	...
	public ResponseEntity<RouteException> handleGlobalException(Exception exception, WebRequest webRequest) {
		RouteException errorDetails = new RouteException(new Date(), exception.getMessage(),
